...
function loginFailure(error:unknown,authenticated:boolean){
 ...
 switch(code){
  case 'auth/invalid-credential':case 'auth/wrong-password':case 'auth/user-not-found':return 'البريد الإلكتروني أو كلمة المرور غير صحيحة. تحقق من حساب Firebase Authentication.';
  ...
  case 'auth/operation-not-allowed':return 'تسجيل الدخول بالبريد وكلمة المرور غير مفعّل في Firebase Authentication.';
  case 'auth/unauthorized-domain':return 'نطاق هذا الموقع غير مضاف إلى النطاقات المصرح بها في Firebase Authentication.';
